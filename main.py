...
@app.route('/administrador/modulo', methods=["GET", "POST"])
def administrador():
    return render_template('inicioadmin.html', mensaje="Modulo de administración")

@app.route('/administrador/modulo/crearvj', methods=["GET", "POST"])
def videojuegosporcrear():
    return render_template('inicioadmin.html', mensaje="Videojuegos por clasificar")

@app.route('/administrador/modulo/actusuarios', methods=["GET", "POST"])
def actividadusuarios():
    return render_template('inicioadmin.html', mensaje="Actividad de usuarios")

@app.route('/administrador/modulo/masbuscados', methods=["GET", "POST"])
def juegosmasbuscados():
    return render_template('inicioadmin.html', mensaje="Cantidad de búsquedas e intercambios")

@app.route('/administrador/modulo/usuariosmascambian', methods=["GET", "POST"])
def usuariosmascambian():
    return render_template('inicioadmin.html', mensaje="Usuarios que más cambian")
